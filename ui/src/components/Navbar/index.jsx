            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <button className="transition duration-500 bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                        ...
                        <div className="ml-3 relative">
                            ...
                            { isUserMenuOn ? <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                                <p className="transition duration-500 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Your Profile</p>
                                <p className="transition duration-500 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Settings</p>
                                <p className="transition duration-500 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Sign out</p>
                            </div> 
                                : null }
