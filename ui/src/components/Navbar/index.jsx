        ...
        <nav className="bg-gray-800">
            ...
            { isMainMenuOn ? <div className="sm:hidden" id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1">
                    {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" --> */}
                    <a className="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium"><NavLink to='/'>Dashboard</NavLink></a>
                    <a className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"><NavLink to='/about'>About</NavLink></a>
                    <a className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"><NavLink to='/help'>Help</NavLink></a>
                </div>
            </div>
                : null }
